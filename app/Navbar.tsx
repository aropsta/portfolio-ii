  ...
  return (
    <nav className="w-full shadow-[0_0_10px_rgba(0,0,0,0.09)] flex bg-white justify-between items-center z-50 px-6  sm:px-12 relative sm:py-4">
      ...
      <button
        ref={btnRef}
        onClick={toggleNav}
        className="sm:hidden p-1.5 font-black cursor-pointer text-xl outline-2 outline-yellow-900 hover:bg-primary transition-colors duration-200 ease-in hover:text-white"
      >
